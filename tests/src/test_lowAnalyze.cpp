...
int main()
{
    std::string testStr =
        ...
        "contributions by the team, from TRECs 1 to 7 is presented in [3]. In "
        "this work, weighting schemes for ad-hoc retrieval were developed, "
        "inspired by a probabilistic interpretation of relevance; this lead, "
        ...
        "MSRC entered only the HARD track, concentrating on the use of the "
        ...
        "link-based features. Section 3 briefly describes the system we used. "
        "Section 4 describes our HARD participation and Section 5 our TREC "
        "participation.";
