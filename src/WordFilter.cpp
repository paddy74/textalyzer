 ...
 */
std::unordered_set<std::string> const & WordFilter::getStopwords(
    std::string const & language)
{
    if (language == "english")
        return WordFilter::englishStopwords;
 ...
 */
template<typename T>
std::vector<T> WordFilter::getSymDiff(
...
std::string const WordFilter::DEFAULT_LANGUAGE = "english";

std::unordered_set<std::string> const WordFilter::englishStopwords =
{
