...
/**
 * @brief Expand all word contractions of the default language ("english").
 *
 * @param wordVect
 */
void WordExpander::expandWords(std::vector<std::string> & wordVect)
{
    WordExpander::expandWords(wordVect, WordExpander::DEFAULT_LANGUAGE);
}
    ...
    std::unordered_map<std::string, std::string> const & contractions)
{
    ...
    if (itr != contractions.end()) word = itr->second;
    // else nothing
}
...
/**
 * @brief Expand a single word contraction of the default language ("english").
 *
 * @param word
 */
...
std::unordered_map<std::string, std::string> const &
    WordExpander::getContractions(std::string const & language)
{
    if (language == "english") return WordExpander::englishContractions;

    // Default: English
    return WordExpander::englishContractions;
}
...
std::string const WordExpander::DEFAULT_LANGUAGE = "english";

std::unordered_map<std::string, std::string> const
    WordExpander::englishContractions = {{"ain't", "am not"},
                                         {"aren't", "are not"},
                                         {"can't", "cannot"},
